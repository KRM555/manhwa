      ...
      <DialogContent className="max-w-md rounded-2xl dir-rtl text-right">
        ...
        {user ? (
          ...
          <div className="space-y-3 py-2">
            {/* زر جوجل */}
            <Button onClick={handleGoogleLogin} variant="outline" className="w-full h-10 text-xs font-bold rounded-xl gap-2.5 bg-white text-gray-800 hover:bg-gray-50 border-gray-300 shadow-sm">
            ...
            {/* زر ديسكورد */}
            <Button onClick={handleDiscordLogin} variant="outline" className="w-full h-10 text-xs font-bold rounded-xl gap-2.5 bg-[#5865F2] hover:bg-[#4752C4] text-white border-none shadow-sm">
