    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-md rounded-2xl dir-rtl text-right">
        ...
        {user ? (
          ...
          <div className="space-y-3<dyad-write path="src/components/AuthModal.tsx" description="Complete AuthModal component with clean exports and no unused imports">
import { useState, useEffect } from 'react';
import { supabase } from '@/lib/supabase';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog';
import { Button } from '@/components/ui/button';
